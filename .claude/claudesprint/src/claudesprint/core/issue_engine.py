...
class IssueEngine:
    ...
    def __init__(
        ...
        self.claude_runner = ClaudeRunner(
            ...
            common_prompt_file=config.common_prompt_file,
    ...
    def _execute_step(self, current_issue: CurrentIssue) -> StepResult:
        ...
        # Get prompt file for this step
        prompt_file = self._get_prompt_file(step)
    ...
    def _get_prompt_file(self, step: IssueStep) -> str:
        """Get the prompt file path for a step.
        ...
        prompt_name = step_to_prompt.get(step, step.value)
        return self.config.get_prompt_file(prompt_name)
